...
7za x '-oC:\Temp\gcc' boost_1_51_0.tar > NUL || { echo boost_1_51_0.tar - EPIC FAIL ; exit 1; }

patch -d /c/temp/gcc/boost_1_51_0 -p1 < boost-BOOST_THREAD_USE_LIB.patch
patch -d /c/temp/gcc/boost_1_51_0 -p1 < boost-bootstrap.patch
...
mv dest boost-1.51.0

echo Packaging...

cd boost-1.51.0
7za -mx0 a ../boost-1.51.0.7z * > NUL || { echo boost-1.51.0.7z - EPIC FAIL ; exit 1; }
