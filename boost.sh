...
7za x '-oC:\Temp\gcc' boost_1_50_0.tar > NUL || { echo boost_1_50_0.tar - EPIC FAIL ; exit 1; }

patch -d /c/temp/gcc/boost_1_50_0 -p1 < boost-BOOST_THREAD_USE_LIB.patch
patch -d /c/temp/gcc/boost_1_50_0 -p1 < boost-bootstrap.patch
patch -d /c/temp/gcc/boost_1_50_0 -p1 < boost-c++11.patch
...
mv dest boost-1.50.0

echo Packaging...

cd boost-1.50.0
7za -mx0 a ../boost-1.50.0.7z * > NUL || { echo boost-1.50.0.7z - EPIC FAIL ; exit 1; }
