...
untar_file coreutils-8.32.tar

patch -d /c/temp/gcc/coreutils-8.32 -p1 < coreutils.patch

cd /c/temp/gcc
mv coreutils-8.32 src
...
cd /c/temp/gcc
rm -rf build src
mv dest coreutils-8.32
cd coreutils-8.32

7z -mx0 a ../coreutils-8.32.7z *
