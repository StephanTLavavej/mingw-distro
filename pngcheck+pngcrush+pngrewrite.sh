...
7za x '-oC:\Temp\gcc' pngcrush-1.7.60-nolib.tar > NUL || fail_with pngcrush-1.7.60-nolib.tar - EPIC FAIL
...
gcc -s -O3 -fomit-frame-pointer pngcrush-1.7.60-nolib/pngcrush.c -o dest/bin/pngcrush.exe -lpng -lz || fail_with pngcrush - EPIC FAIL

gcc -s -O3 -fomit-frame-pointer pngrewrite-1.4.0/*.c -o dest/bin/pngrewrite.exe -lpng -lz || fail_with pngrewrite - EPIC FAIL

rm -rf pngcheck-2.3.0 pngcrush-1.7.60-nolib pngrewrite-1.4.0
