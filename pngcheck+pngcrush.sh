...
7z x '-oC:\Temp\gcc' pngcrush-1.7.76-nolib.tar > NUL || fail_with pngcrush-1.7.76-nolib.tar - EPIC FAIL
...
gcc -s -O3 pngcrush-1.7.76-nolib/pngcrush.c -o dest/bin/pngcrush.exe -lpng -lz || fail_with pngcrush - EPIC FAIL

rm -rf pngcheck-2.3.0 pngcrush-1.7.76-nolib
