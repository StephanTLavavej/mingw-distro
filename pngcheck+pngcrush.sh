...
extract_file pngcrush-1.8.1-nolib.tar
...
gcc -s -O3 pngcrush-1.8.1-nolib/pngcrush.c -o dest/bin/pngcrush.exe -lpng -lz || fail_with pngcrush 1 - EPIC FAIL

rm -rf pngcheck-2.3.0 pngcrush-1.8.1-nolib
